...
:: run test_full
call xsim top_sim -R -testplusarg "UVM_TESTNAME=test_full" -cov_db_name cov_test_full > xsim_test_full.log 2>&1
if %ERRORLEVEL% NEQ 0 echo [WARNING] test_full failed!
